...
namespace Erweiterungsfaktor.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await man.PasswordSignInAsync(model.UserName , model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //Hier wäre auch zu prüfen, ob die angegebene Mail-Adresse bestätigt ist - await UserManager.IsEmailConfirmedAsync(user.Id)
                if (user == null)
                {
                ...
                //Hier wäre der E-Mail-Versand einzubinden
                //Nur zur Demonstration, den Reset-Link	an die "Link versendet"-Seite übergeben
                return RedirectToAction("ForgotPasswordConfirmation", "Account",
                    new { PasswordResetMessage = callbackUrl});
            }
            // Wurde dieser Punkt erreicht, ist ein Fehler aufgetreten; Formular erneut anzeigen.
            return View(model);
        }
        ...
        [AllowAnonymous]
        public ActionResult ForgotPasswordConfirmation(string PasswordResetMessage)
        {
            ViewBag.PasswordResetMessage = PasswordResetMessage;
            return View();
        }
